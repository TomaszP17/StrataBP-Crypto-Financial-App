...
import code.listeners.AllTransactionButtonListener;
import code.listeners.BackButtonHistoryListener;
import code.listeners.ReceivedHistoryButtonListener;
import code.listeners.SentHistoryButtonListener;
...
public class HistoryWindow extends JFrame{
    ...
    public static void addUserTransactions(Client currentClient, DefaultTableModel tableModel, List<Transaction> data) {
